      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Container(
                padding: EdgeInsets.fromLTRB(2.0, 40.0, 40.0, 50.0),
                width: double.infinity,
                child: 
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Container(
                        margin: EdgeInsets.fromLTRB(10.0, 20.0, 1.0, 1.0),
                        width: double.infinity,
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    margin: EdgeInsets.fromLTRB(10.0, 3.0, 40.0, 10.0),
                                    child: Text("Peserta Praktik Kerja Lapangan",
                                    style: TextStyle(
                                      fontSize: 14,
                                      color: Colors.white
                                    ),
                             ...
                             Container(
                                    ...
                                    child: Image.asset('assets/image/elang.jpeg', fit : BoxFit.cover),),
                                  ),
                          ],
                        ),
                      )
              ...
              //   child: Text('Waktu',style: TextStyle(fontSize: 17),),
              // )
            ],
          ),
